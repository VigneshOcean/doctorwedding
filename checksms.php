...
$message=urlencode ("Doctor Life Matrimony: Your OTP is 55555. It will expire in 5 minutes -HMMATR");

// Doctor Life Matrimony: Your OTP is {#var#}. It will expire in 5 minutes -HMMATR
$ch = curl_init ();
...
$myHITurl = "http://site.ping4sms.com/api/httpapi?username=doctorwedding&password=success&sender=HMMATR&route=2&number=9677949101&sms=".$message."&templateid=1607100000000382544";
