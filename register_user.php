...
<tr>
<td width="35%" class="p5px10px">Profile Created by </td>
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select name="profile" id="profile" class="input" style="width:290px;">
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select name="refernce" id="refernce" class="input" style="width:290px;">
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<input type="text" class="input w90" style="padding:3px;" name="p_birth" id="p_birth" value="" tooltipText="Plz specify the Place of birth" />
<p class="error" id="dob_error"></p>
</td>
</tr>

<tr>
<td class="p5px10px">Order of Birth</td>
<td class="p5px b gray">:</td>
<td class="p5px10px">
<input type="text" class="input w90" style="padding:3px;" name="order_birth" id="order_birth" value="" tooltipText="Plz specify Order of Birth" />
<p class="error" id="dob_error"></p>
</td>
</tr>

<tr>
<td class="p5px10px">Native Place</td>
<td class="p5px b gray">:</td>
<td class="p5px10px">
<input type="text" class="input w90" style="padding:3px;" name="native_place" id="native_place" value="" tooltipText="Plz specify Native Place" />
<p class="error" id="dob_error"></p>
</td>
</tr>
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<input type="text" class="input w90" style="padding:3px;" name="age" id="age" value="" tooltipText="Plz specify Age" />
<p class="error" id="dob_error"></p>
</td>
</tr>
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select name="house_type" id="house_type" class="input" style="width:290px;">
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select name="home_type" id="home_type" class="input" style="width:290px;">
<option value="">-Select-</option>
...
<td class="p5px10px">
<input type="file" class="input" size="30" name="uploadedfile"  id="uploadedfile"/>
<p class="xxsmall">Images in .jpeg/.jpg & .gif format &amp; under 2 MB in size can be uploaded.</p>
<p class="xxsmall">A photo can tell thousand things without talking, It's the perfect way to attract more profile </p>
</td>
</tr>
<tr>
<td width="35%" class="p5px10px">Caste <span class="star">*</span> </td>
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select name="religion" id="religion" class="input" style="width:290px;"  onchange="getcity(this.value);">
<option value="">--select--</option>
<?php
$caste = mysqli_query($con,"select * from caste where temp_id=1");
while($caste_row = mysqli_fetch_array($caste))
{					
?>
<option value="<?php echo $caste_row['id']; ?>"><?php echo $caste_row['caste']; ?></option>
<?php					
}
?>
</select>                                           
...
<tr>
<td width="35%" class="p5px10px">Sub Caste <span class="star">*</span></td>
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select id="caste" name="caste" class="input" style="width:290px;" >
<option value="">--select--</option>
</select>                                         
<p class="error" id="profile_error"></p>
</td>
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select name="status1" id="status1" class="input" style="width:290px;" >
<option value="">--select--</option>
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<select name="skin" id="skin" class="input" style="width:290px;" >
<option value="">--select--</option>
...
<option value="4 Ft 1 In - 124 Cm">4 Ft 1 In - 124 Cm</option>
<option value="4 Ft 2 In - 127 Cm">4 Ft 2 In - 127 Cm</option>
<option value="4 Ft 3 In - 129 Cm">4 Ft 3 In - 129 Cm</option>
<option value="4 Ft 4 In - 132 Cm">4 Ft 4 In - 132 Cm</option>
<option value="4 Ft 5 In - 134 Cm">4 Ft 5 In - 134 Cm</option>
<option value="4 Ft 6 In - 137 Cm">4 Ft 6 In - 137 Cm</option>
<option value="4 Ft 7 In - 139 Cm">4 Ft 7 In - 139 Cm</option>
<option value="4 Ft 8 In - 142 Cm">4 Ft 8 In - 142 Cm</option>
<option value="4 Ft 9 In - 144 Cm">4 Ft 9 In - 144 Cm</option>
...
<option value="5 Ft 1 In - 154 Cm">5 Ft 1 In - 154 Cm</option>
<option value="5 Ft 2 In - 157 Cm">5 Ft 2 In - 157 Cm</option>
<option value="5 Ft 3 In - 160 Cm">5 Ft 3 In - 160 Cm</option>
<option value="5 Ft 4 In - 162 Cm">5 Ft 4 In - 162 Cm</option>
<option value="5 Ft 5 In - 165 Cm">5 Ft 5 In - 165 Cm</option>
<option value="5 Ft 6 In - 167 Cm">5 Ft 6 In - 167 Cm</option>
<option value="5 Ft 7 In - 170 Cm">5 Ft 7 In - 170 Cm</option>
<option value="5 Ft 8 In - 172 Cm">5 Ft 8 In - 172 Cm</option>
...
<option value="6 Ft 2 In - 187 Cm">6 Ft 2 In - 187 Cm</option>
<option value="6 Ft 3 In - 190 Cm">6 Ft 3 In - 190 Cm</option>
<option value="6 Ft 4 In - 193 Cm">6 Ft 4 In - 193 Cm</option>
<option value="6 Ft 5 In - 195 Cm">6 Ft 5 In - 195 Cm</option>
<option value="6 Ft 6 In - 198 Cm">6 Ft 6 In - 198 Cm</option>
<option value="6 Ft 7 In - 200 Cm">6 Ft 7 In - 200 Cm</option>
<option value="6 Ft 8 In - 203 Cm">6 Ft 8 In - 203 Cm</option>
<option value="6 Ft 9 In - 205 Cm">6 Ft 9 In - 205 Cm</option>
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<input style="width:55px; padding:3px;" type="text" class="input" name="mobile_cont_code" id="mobile_cont_code" onkeypress="return isNumberKey(event)" value="91" readonly/> - 
<input type="text" name="mobile" id="mobile" value="" class="input w90" style="padding:3px;width:200px;"  onfocus="event_on_focus('mobile','Mobile No.')" onblur="event_on_blur('mobile','Mobile No.')"  maxlength="30"  />
<p class="error" id="mobile_error"></p>
<br /><p style="font-size:11px;"><b class="red">Note: </b>Please enter Valid Mobile No. to activate your profile.</p>
<p style="font-size:11px;"><b class="red">Eg: </b>978818**** or 978818****,801289****</p>
</td>
</tr>
<tr valign="top">
...
<td class="p5px b gray" width="5">:</td>
<td class="p5px10px"><textarea name="address" id="address" style="width: 263px; height: 70px;"></textarea>
<p class="error" id="username_error"></p>
</td>
</tr>
...
<option value="">--select--</option>
<?php
$education = mysqli_query($con,"select * from education where temp_id=1");
while($education_row = mysqli_fetch_array($education))
{					
?>
<option value="<?php echo $education_row['education']; ?>"><?php echo $education_row['education']; ?></option>
<?php					
}
?>
</select>                                           
...
<td class="p5px b gray">:</td>
<td class="p5px10px"><input type="text" class="input w90"  name="edu_det" id="edu_det"  value="" tooltipText="Enter degree name"  />
<p class="error" id="username_error"></p>   
</td>
</tr>
<tr>
...
<td class="p5px b gray">:</td>
<td class="p5px10px"><input type="text" class="input w90"  name="job_cmpy" id="job_cmpy"  value=""   />
<p class="error" id="username_error"></p>   
</td>
</tr>
<tr>
...
<td class="p5px b gray">:</td>
<td class="p5px10px"><input type="text" class="input w90"  name="job_loc" id="job_loc"  value="" />
<p class="error" id="username_error"></p>   
</td>
</tr>
<tr>
...
<td class="p5px b gray">:</td>
<td class="p5px10px"><input name="falive" type="radio" class="vam" value="Alive" checked="checked"  >Alive &nbsp;
<input class="vam" name="falive" type="radio" value="Not Alive"  />Not Alive
</td>
</tr>
<tr valign="top">
...
<td class="p5px b gray">:</td>
<td class="p5px10px"><input name="malive" type="radio" class="vam" value="Alive" checked="checked"  >Alive &nbsp;
<input class="vam" name="malive" type="radio" value="Not Alive"  />Not Alive
</td>
</tr>
<tr valign="top">
...
<td class="p5px b gray" width="5">:</td>
<td class="p5px10px"><textarea name="self_desc" id="self_desc" style="width: 263px; height: 70px;"></textarea>
<p class="error" id="username_error"></p>
</td>
</tr>
...
<td class="p5px b gray">:</td>
<td class="p5px10px">
<input name="dosam" type="radio" class="vam" value="sevvai dosam" >Sevvai Dosam &nbsp;
<input class="vam" name="dosam" type="radio" value="ragu dosam"  />Ragu Dosam&nbsp;
<input name="dosam" type="radio" class="vam" value="sevvai+ragu dosam" >Sevvai+Ragu Dosam &nbsp;
<input class="vam" name="dosam" type="radio" value="none" checked="checked"  />None&nbsp;
</td>
</tr>
...
<td class="p5px b gray" width="5">:</td>
<td class="p5px10px"><textarea name="self_dosam" id="self_dosam" style="width: 263px; height: 70px;"></textarea>
<p class="error" id="username_error"></p>
</td>
</tr>
...
<td class="p5px b gray" width="5">:</td>
<td class="p5px10px"><input type="text" class="input w90"  name="area" id="area"  value="" />
<p class="error" id="username_error"></p>
</td>
</tr>
...
<button type="submit"><span style="color:#FFFFFF; padding:5px; font-size:16px; font-weight:bold;">Register Now</span></button>
</div>
</td>
</tr>
</table>
