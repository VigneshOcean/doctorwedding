...
<title>Doctor Life Matrimony:Inbox</title>
...
$religion=$row_rr['religion'];
$e=mysqli_query($con,"select * from  message where caste='$religion' order by id desc");
...
<td><?php echo $i; ?></td>
<td>
<?php echo $row_e['subject']; ?>
</td>
<td>
<?php echo substr($row_e['message'],0,25); ?> ..
</td>
<td>
<?php echo $row_e['c_date']; ?>
</td>
<td>
<a href="read_message.php?c_id=<?php echo $row_e['id'];?>"  title="Read Message" class="icon-2 info-tooltip">
<button class="btn btn-sm btn-warning"><i class="icon-edit  bigger-110"></i><span class="bigger-110 no-text-shadow">Read full message</span></button>
</a>
</td>
<td></td>
<td></td>
