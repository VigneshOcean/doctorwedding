...
<i class="icon-remove"></i></button><i class="icon-ok red"></i>
<strong class="red">Your Profile Validity Going to expiry</strong>!</div>
<table style="font-size:18px;">
<tr>
<td>Package Activiated on :</td><td> <?php echo $riw_ghj['today_date']; ?></td>
</tr>
<tr>
<td>Package Expiry date :</td><td> <?php echo $riw_ghj['valid_for']; ?></td>
</tr>
</table>
<?php
/*}*/
