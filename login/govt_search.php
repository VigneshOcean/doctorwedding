...
<title>Doctor Life Matrimony:Govt Search</title>
...
<div class="page-header"><h1>Govt Search</h1></div>      
<div class="row"><div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<form class="form-horizontal" role="form" action="govt_search.php" method="post" enctype="multipart/form-data"  onSubmit="return validlogin();">
...
<div class="col-sm-9"  style="width:350px;">
<div>
<select  name="education" id="education" data-placeholder="Select Education Name...">
