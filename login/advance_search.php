...
if($his_age!='')
{
  $plus_age=$row_reg['age']+7;
  $minus_age=$row_reg['age']-7;
...
<title>Doctor Life Matrimony:Advance Search</title>
...
?>
 <!--<p><h3><?php echo  $count_a; ?> - Total <?php echo $tag; ?> Profiles</h3></p>-->
 
 <div class="infobox infobox-green" style="width: 300px; !important">
...
{
    $tag ='Female';
    $a1=mysqli_query($con,"SELECT count(*) as cnt,education FROM `register` WHERE  education!='' and gender ='female'  group by education order by education asc ");
}else{
      $tag ='Male';
      $a1=mysqli_query($con,"SELECT count(*) as cnt,education FROM `register` WHERE education!='' and gender ='male'  group by education order by education asc  ");
}
 ?>
 <?php while($cntdet=mysqli_fetch_assoc($a1))
{ 

?>
  <!-- <p><h3><?php echo  $cntdet['cnt']; ?> - Total <?php echo  $cntdet['education']; ?> Profiles</h3></p>--->
<div class="infobox infobox-green" style="width: 300px; !important">
<div class="infobox-icon"><i class="icon-group"></i></div>
<div class="infobox-data"><span class="infobox-data-number"><?php echo  $cntdet['cnt']; ?></span>
<div class="infobox-content" style="color:#DD6566; font-weight:bold;"><a href="advance_search.php">Total <?php echo  $cntdet['education']; ?> Profiles</a></div></div>
<!--<div class="stat stat-success">8%</div>-->
</div>
  <?php } ?>
</div>
