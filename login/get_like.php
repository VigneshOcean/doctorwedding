...
//$message=urlencode ("Mr/Miss ".$name.",Your profile has been liked by ".$sendername."(".$username.")-doctorwedding.com only for adidravidar.Contact:7338821446");
$message=urlencode ("Mr/Miss ".$name.",Your profile has been liked by ".$sendername."- please visit- doctorlifematrimony.com only for Doctors -HMMATR");
...
curl_setopt($curl, CURLOPT_URL, "http://site.ping4sms.com/api/httpapi?username=hmmatrimony&password=success&sender=HMMATR&route=2&number=".$clientmobile."&sms=".$message."&templateid=1607100000000382545"); 
