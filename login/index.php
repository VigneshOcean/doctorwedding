...
return true;
 ...
 <a href="../index.php"><button class="width-35 pull-right btn btn-sm btn-primary" type="button"><i class="icon-edit"></i>Back to Site</button>          </a>
...
<div>
<a href="../register.php" class="user-signup-link">New User<i class="icon-arrow-right"></i></a>
</div>
										</div>
									</div><!-- /widget-body -->
								</div>
