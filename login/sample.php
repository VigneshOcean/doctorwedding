...
<tr>
<td width="18%" align="right"><span style="color:#0033FF; font-weight:bold; font-size:14px;"></span></td>
<td width="1%"></td>
<td width="25%"><span style="font-size:14px;"></span></td>
<td width="20%" align="right"><span style="color:#0033FF; font-weight:bold; font-size:14px;">Userid</span></td>
<td width="1%">:</td>
<td width="35%"><?php echo ucwords($usprod['username']); ?></td>
</tr>
<tr>
...
<td width="20%" align="right"><span style="color:#0033FF; font-weight:bold; font-size:14px;">Phone</span></td>
<td width="1%">:</td>
<td width="35%"><?php echo ucwords($usprod['mobile']); ?></td>
</tr>
...
<td>:</td>
<td colspan="4">
<img src="http://doctorwedding.com/admin/horo/<?php echo $usprod['horo']; ?>" height="300" width="500" />
</td>
</tr>
<?php
}
