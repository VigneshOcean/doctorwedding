...
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 ...
 //alert(xmlHttp.responseText);
  var a=xmlHttp.responseText;
	window.location='govt_result.php?page=<?php echo $page; ?>';
...
$lid = $_SESSION['id'];
//get education cost//
$my=mysqli_query($con,"select * from register where id='$lid'");
...
if($valid_string==''){  $profilecost_flg =1; }
 $cc=mysqli_query($con,"select * from getcontact_history where sender_id='$lid' and to_id='$userid' and CURDATE() between valid_from and valid_to");   
...
<?php if($profilecost_flg==1 && $count_contactinfo==0) {   ?>
<div style="text-align:center ;"><span style="color:#009933; font-weight:bold;">Get Contact Info</span>
<a class="btn btn-app btn-success btn-xs"  href="javascript:void(0)"<?php if($wallet==0 || $wallet < $profilecost || $walet_validity_mess==1){ echo 'title="Add balance to your wallet"   ';   ?> data-toggle="modal" data-target="#myModal"   <?php }  else { ?> onClick="getcontact(<?php echo $userid; ?>,<?php echo $profilecost; ?>)" <?php } ?>  ><i class="icon-money  bigger-160"></i>Pay <?php echo $profilecost; ?> </a></div>  
<?php } ?>
...
<td>:</td>
<td><span style="color:#FF0000; font-size:14px;"><?php if($valid_string!='' || $count_contactinfo!=0) { echo $usprod['mobile']; } else { echo '******'; }  ?></span></td>
<td align="right"><span style="color:#0033FF; font-weight:bold; font-size:14px;">Email</span></td>
<td>:</td>
<td><span style="color:#FF0000; font-size:14px;"><?php if($valid_string!='' || $count_contactinfo!=0) { echo $usprod['email']; } else { echo '******'; }  ?></span></td>
</tr>
<tr>
...
<td>:</td>
<td colspan="4"><span style="color:#FF0000; font-size:14px;"><?php if($valid_string!=''|| $count_contactinfo!=0) { echo ucwords($usprod['address']); } else { echo '******'; }  ?></span></td>
</tr>
<tr>
...
$horo=$usprod['horo'];
if($valid_string!=''|| $count_contactinfo!=0) 
{
if($horo!='')
{
?>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <ul>
                <li><b> 300</b> (15 Days - 10 Contacts)</li>
