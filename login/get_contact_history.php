...
<title>Doctor Life Matrimony:Contact details</title>
...
$e=mysqli_query($con,"select * from getcontact_history where sender_id='$id' and CURDATE() between valid_from and valid_to order by id desc");
