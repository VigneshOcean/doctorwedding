          ...
          <div class="col-sm-5">
            ...
            <div class="login-sec"> 
              ...
              <div class="uou-tabs">
                <!-- REGISTER -->
                <div class="content">
                  <h5 class="text-center alert-info" style="color:#fff;font-size: 18px; line-height: 30px;">Paid customer login</h5>
                  <!-- LOGIN -->
...
<section class="demo-section">
   <div class="contaniner">
            <div class="row profile-main" id="Payment" style="text-align: center;">
              ...
              <div class="col-xs-4">
              <div class="col-sm-12 mt15 mb15 pr0"><span class="price-plancss" >RS 3000 / </span><br><span class="price-plancss2" > 6 MONTHS</span><br>
               <a class="btn btn-transparent-primary  btn1" style="font-size: 10px;"  href="paynow.php?plan_id=1">Join Now</a></div>
             </div>
             <div class="col-xs-4">
              <div class="col-sm-12 mt15 mb15 pr0 "><span class="price-plancss" ">RS 4000 /</span></span> <br><span class="price-plancss2" >1 YEAR</span><br>
               <a class="btn btn-transparent-primary  btn1" style="font-size: 10px;" href="paynow.php?plan_id=2">Join Now</a></div>
             </div>
             <div class="col-xs-4">
              <div class="col-sm-12 mt15 mb15 pr0 "><span class="price-plancss" ">RS 7000 /</span> <br><span class="price-plancss2" >UPTO MARRIAGE</span><br>
               <a class="btn btn-transparent-primary  btn1" style="font-size: 10px;"href="paynow.php?plan_id=3">Join Now</a></div>
             </div>
           </div>
         </div>
  </section>
...
à®†à®¤à®¿à®¤à®¿à®°à®¾à®µà®¿à®Ÿà®°à¯ à®¤à®¿à®°à¯à®®à®£ à®¤à®•à®µà®²à¯ à®®à¯ˆà®¯ à®‡à®£à¯ˆà®¯à®¤à®³à®¤à¯à®¤à¯à®¤à®¿à®±à¯à®•à¯ à®
