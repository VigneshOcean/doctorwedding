...
<title>Doctor Life Matrimony:Mobile search Result</title>
...
{
var new_current_page_name = document.getElementById("current_page_name").value;
...
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {
	window.location='mobile_search_result.php';
...
$query11=" where mobile like '%$mobile%' ";

?>
<?php
   $tableName="register";
   $targetpage = "mobile_search_result.php"; 	
	$limit = 20; 
    ...
    $paginate .= "<div class='paginate'>";
        if ($page > 1)
		{
			// Pagination buttons construction (removed redundant mysqli_query calls)
$paginate.= "<a href='$targetpage?page=$1'>$2</a>";
		}else{
...
<input id="command" type="hidden" style="width:50px;" name="command" value="mobile_search_result.php">
<div align="right">
Goto page no:   
...
<h3 class="header smaller lighter blue">
    Result #<?php echo $i++; ?> (Total: <?php echo $total_pages; ?>)
</h3>
<p style="float:right;">
...
<?php
    ...
    echo "<div class='alert alert-danger'>No profiles found matching your mobile number search.</div>";
}
?>
</div>
</ul>
