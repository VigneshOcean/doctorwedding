...
echo "<script language='javascript'>window.location='paid_search_result.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8" />
<title>Doctor Life Matrimony:Paid customer Search</title>
...
<div class="page-header"><h1>Paid Customer Search</h1></div>      
<div class="row"><div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<form class="form-horizontal" role="form" action="paid_search.php" method="post" enctype="multipart/form-data">
...
<div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">Select Category :</label>
<div class="col-sm-9"  style="width:350px;">
<div>
<select class="width-80 chosen-select"  name="valid" id="valid" data-placeholder="Select customer status..." required>
<option value="">--Select customer status--</option>
<option value="1">Paid Customer</option>
<option value="2">Not Paid Customer</option>
</select>
</div>
</div></div>
