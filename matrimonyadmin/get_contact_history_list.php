...
<title>Doctor Life Matrimony:Contact History</title>
...
$cona ='';
if($senderid!='')
$cona.=" and sender_id = ".$senderid.""; 
if($to_id!='')
$cona.=" and to_id = ".$to_id.""; 
//echo "select * from  getcontact_history where 1  $con order by id desc";
$e=mysqli_query($con,"select * from  getcontact_history where 1  $cona order by id desc");
...
<div class="page-header"><h1>Contact History</h1></div>
<table id="sample-table-2" class="table table-striped table-bordered table-hover">
<thead>
<tr>
<th>S.No</th>
<th>User Name / ID / Mobile</th>
<th>Get Contact User Name / ID / Mobile</th>
<th>Pay Amount</th>
<th>Valid To</th>
<th>IP Address</th>
</tr>
