...
<title>Doctor Life Matrimony:Name Result</title>
...
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {
	window.location='name_result.php';
...
<div class="row"><div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<?php
$search_id=$_SESSION['name'];
$caste=$_SESSION['caste'];
$dob=$_SESSION['dob'];
$photo1=$_SESSION['photo1'];
if($photo1=='0')
{
if($search_id=='' && $caste=='' && $dob=='')
{
$query11="where  uploadedfile!=''";
}
if($search_id!='' && $caste=='' && $dob=='')
{
$query11="where name like '%$search_id%' and uploadedfile!=''";
}
if($search_id=='' && $caste!='' && $dob=='')
{
$query11="where  religion='$caste' and uploadedfile!=''";
}
if($search_id=='' && $caste=='' && $dob!='')
{
$query11="where  dob='$dob' and uploadedfile!=''";
}
if($search_id!='' && $caste!='' && $dob=='')
{
$query11="where  name like '%$search_id%' and religion='$caste' and uploadedfile!=''";
}
if($search_id!='' && $caste=='' && $dob!='')
{
$query11="where   name like '%$search_id%' and dob='$dob' and uploadedfile!=''";
}
if($search_id=='' && $caste!='' && $dob!='')
{
$query11="where  religion='$caste' and dob='$dob' and uploadedfile!=''";
}
if($search_id!='' && $caste!='' && $dob!='')
{
$query11="where  name like '%$search_id%' and religion='$caste' and dob='$dob' and uploadedfile!=''";
}
}
...
if($search_id!='' && $caste=='' && $dob=='')
{
$query11="where name like '%$search_id%'";
}
if($search_id=='' && $caste!='' && $dob=='')
{
$query11="where  religion='$caste'";
}
if($search_id=='' && $caste=='' && $dob!='')
{
$query11="where  dob='$dob'";
}
if($search_id!='' && $caste!='' && $dob=='')
{
$query11="where  name like '%$search_id%' and religion='$caste'";
}
if($search_id!='' && $caste=='' && $dob!='')
{
$query11="where   name like '%$search_id%' and dob='$dob'";
}
if($search_id=='' && $caste!='' && $dob!='')
{
$query11="where  religion='$caste' and dob='$dob'";
}
if($search_id!='' && $caste!='' && $dob!='')
{
$query11="where  name like '%$search_id%' and religion='$caste' and dob='$dob'";
}
}
?>
<?php
   $tableName="register";
   $targetpage = "name_result.php"; 	
	$limit = 20; 
...
<input id="command" type="hidden" style="width:50px;" name="command" value="name_result.php">
<div align="right">
Goto page no:   
...
{
?>
<span style='font-weight:bold; color:#FF0000;'>No Records Found</span>
<?php
}
?>
</div>
