...
<title>Doctor Life Matrimony:Inbox Comman</title>
...
$e=mysqli_query($con,"select * from  contact where private_message!='' order by id desc");
...
<div class="page-header"><h1>Inbox (Private message)</h1></div>
...
<tr>
<td><?php echo $i; ?></td>
<td><?php echo $row_e['name']; ?></td>
<td><?php echo $row_e['email']; ?></td>
<td><?php echo $row_e['mobile']; ?></td>
<td><?php echo $row_e['msg']; ?></td>
<td><?php echo $row_e['c_date']; ?></td>
<td><a href="delete_enquiry.php?id=<?php echo $row_e['id'];?>&comm=private" onClick="return confirm('Are you sure you want to delete?')" title="Delete Enquiry" class="icon-2 info-tooltip">Delete</a></td>
</tr>	
<?php
$i++;
}
