...
{
$c_id=$_REQUEST['c_id'];
$e=mysqli_query($con, "select * from caste where id='$c_id'");
$row_e=mysqli_fetch_array($e);
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8" />
<title>Doctor Life Matrimony:Edit Caste</title>
...
<input type="hidden" name="command" id="command" value="edit_caste"/>
<input type="hidden" name="c_id" id="c_id" value="<?php echo $c_id; ?>"/>
<div class="col-sm-4">
<div class="widget-box">
<div class="widget-header"><h4>Edit Caste Name</h4></div>
<div class="widget-body"><div class="widget-main">


<div><label for="form-field-select-3">Caste Name</label><br />
<input type="text" name="caste" id="caste" value="<?php echo $row_e['caste']; ?>" />
</div>	                    
...
<button type="submit" name="submit" id="submit" class="btn btn-purple btn-sm">Edit Caste<i class="icon-edit  icon-on-right bigger-110"></i></button>
&nbsp;&nbsp;&nbsp;
<a href="view_caste.php">
