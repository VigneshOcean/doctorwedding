...
<title>Doctor Life Matrimony:Like details</title>
...
$e=mysqli_query($con,"select * from  likes where to_id='$userid' order by id desc");
...
<?php
$iu1=mysqli_query($con,"select * from  register where id='$userid'");
$row_iu1=mysqli_fetch_array($iu1);
?>
<div class="page-header"><h1><?php echo $row_iu1['name']; ?> Likes History</h1></div>
...
<td><?php echo $row_iu['username']; ?></td>
