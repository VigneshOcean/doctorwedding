...
<input type="hidden" name="caste_id" id="caste_id" value="<?php echo $caste_id; ?>"/>
<?php
$uu=mysqli_query($con, "select * from caste where id='$caste_id'");
...
<div class="col-sm-9"><?php echo ucwords($row_uu['caste']); ?></div></div>
<div class="space-4"></div>

<div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Message : </label>
<div class="col-sm-9">
<textarea name="mess" id="mess"></textarea></div></div>
<div class="space-4"></div>

<div class="clearfix form-actions"><div class="col-md-offset-3 col-md-9">
<button class="btn btn-info" type="submit" name="submit" id="submit"><i class="icon-envelope-alt bigger-110"></i>Send to All</button>
