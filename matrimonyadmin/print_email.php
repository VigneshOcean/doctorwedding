...
if($ma1['horo']!='') {
?>
<tr> <td height="34"></td> <td class="topic">Horoscope</td> <td colspan="5"><img src="http://www.doctorwedding.com/matrimonyadmin/horo/<?php echo $ma1['horo']; ?>" height="270" width="517" /></td>
    </tr>
<?php } ?>
</tbody>
</table>
