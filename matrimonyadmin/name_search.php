...
echo "<script language='javascript'>window.location='name_result.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-header"><h1>Name Search</h1></div>      
<div class="row"><div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<form class="form-horizontal" role="form" action="name_search.php" method="post" enctype="multipart/form-data">

<div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Name : </label>
<div class="col-sm-9"><input  id="name" class="col-xs-10 col-sm-4" type="text"  name="name" ></div></div>
...
<div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Dateof Birth : </label>
<div class="col-sm-9"><input id="id-date-picker-1"  name="dob" class="form-control date-picker" type="text" data-date-format="dd/mm/yyyy" style="width:240px; float:left;" ><span class="input-group-addon"  style="width:35px; height:34px;" >
