...
<title>Doctor Life Matrimony:City Result</title>
...
if($photo1=='0')
{
if($gender=='' && $area=='' && $caste=='')
{
$query11="where  uploadedfile!=''";
}
if($gender!='' && $area=='' && $caste=='')
{
$query11="where gender='$gender' and uploadedfile!=''";
}
if($gender=='' && $area!='' && $caste=='')
{
$query11="where area like '%$area%' and uploadedfile!=''";
}
if($gender=='' && $area=='' && $caste!='')
{
...
if($gender!='' && $area!='' && $caste=='')
{
$query11="where gender='$gender' and area like '%$area%' and uploadedfile!=''";
}
if($gender!='' && $area=='' && $caste!='')
{
$query11="where gender='$gender' and  religion='$caste' and uploadedfile!=''";
}
if($gender=='' && $area!='' && $caste!='')
{
$query11="where area like '%$area%' and  religion='$caste' and uploadedfile!=''";
}
if($gender!='' && $area!='' && $caste!='')
{
$query11="where gender='$gender' and area like '%$area%' and  religion='$caste' and uploadedfile!=''";
}
}
else if($photo1=='1')
{
...
if($gender!='' && $area=='' && $caste=='')
{
$query11="where gender='$gender'";
}
if($gender=='' && $area!='' && $caste=='')
{
$query11="where area like '%$area%'";
}
if($gender=='' && $area=='' && $caste!='')
{
...
if($gender!='' && $area!='' && $caste=='')
{
$query11="where gender='$gender' and area like '%$area%'";
}
if($gender!='' && $area=='' && $caste!='')
{
$query11="where gender='$gender' and  religion='$caste'";
}
if($gender=='' && $area!='' && $caste!='')
{
$query11="where area like '%$area%' and  religion='$caste'";
}
if($gender!='' && $area!='' && $caste!='')
{
$query11="where gender='$gender' and area like '%$area%' and  religion='$caste'";
}
}
?>
<?php
   $tableName="register";
   $targetpage = "city_search.php"; 	
	$limit = 20; 
...
<input id="command" type="hidden" style="width:50px;" name="command" value="city_search.php">
<div align="right">
Goto page no:   
