...
<title>Doctor Life Matrimony:Active Profile</title>
...
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {
	window.location='active_users.php';
...
$e=mysqli_query($con,"select * from  register  where status='1'  order by  name  asc");
