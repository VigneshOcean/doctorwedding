...
<title>Doctor Life Matrimony:Marraige Notification</title>
...
$e=mysqli_query($con,"select * from  marriage_notification where to_id IS NULL OR to_id = ''  group by sender_id order by id desc");
