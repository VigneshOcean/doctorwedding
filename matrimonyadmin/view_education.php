...
<title>Doctor Life Matrimony:View Education </title>
...
<input type="hidden" name="command" id="command" value="education"/>
<div class="col-sm-4">
<div class="widget-box">
<div class="widget-header"><h4>Add Education</h4></div>
...
<button type="submit" name="submit" id="submit" class="btn btn-purple btn-sm">Add Education<i class="icon-save  icon-on-right bigger-110"></i></button>
</span>          
...
$e=mysqli_query($con,"select * from  education order by id asc");
...
<div class="page-header"><h1>List of Education</h1></div>
...
<tr>
<td><?php echo $i; ?></td>
<td><?php echo $row_e['education']; ?></td>
<td><?php echo $row_e['cost']; ?></td>
<td>
<a href="edit_education.php?c_id=<?php echo $row_e['id'];?>" onClick="return confirm('Are you sure you want to  Edit Education Name?')" title="Delete Caste" class="icon-2 info-tooltip">
<button class="btn btn-sm btn-warning"><i class="icon-edit  bigger-110"></i><span class="bigger-110 no-text-shadow">Edit</span></button>
</a>
</td>
<td>
<a href="delete_education.php?id=<?php echo $row_e['id'];?>" onClick="return confirm('Are you sure you want to delete?')" title="Delete Education" class="icon-2 info-tooltip">
