...
echo "<script language='javascript'>window.location='city_search.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-header"><h1>City Search</h1></div>      
<div class="row"><div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<form class="form-horizontal" role="form" action="area_search.php" method="post" enctype="multipart/form-data">
...
<div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1"> City Name : </label>
<div class="col-sm-9"><input  id="city" class="col-xs-10 col-sm-4" type="text"  name="city" ></div></div>
<div class="space-4"></div>
