...
<title>Doctor Life Matrimony:View Caste</title>
...
<input type="hidden" name="command" id="command" value="caste"/>
<div class="col-sm-4">
<div class="widget-box">
<div class="widget-header"><h4>Add Caste</h4></div>
<div class="widget-body"><div class="widget-main">

<div><label for="form-field-select-3">Caste Name</label><br />
...
<button type="submit" name="submit" id="submit" class="btn btn-purple btn-sm">Add Caste<i class="icon-save  icon-on-right bigger-110"></i></button>
</span>          
...
$e=mysqli_query($con,"select * from  caste order by caste asc");
...
<div class="page-header"><h1>List of Caste</h1></div>
...
<tr>
<td><?php echo $i; ?></td>
<td><?php echo $row_e['caste']; ?></td>
<td>
<a href="edit_caste.php?c_id=<?php echo $row_e['id'];?>" onClick="return confirm('Are you sure you want to  Edit Caste Name?')" title="Delete Caste" class="icon-2 info-tooltip">
<button class="btn btn-sm btn-warning"><i class="icon-edit  bigger-110"></i><span class="bigger-110 no-text-shadow">Edit</span></button>
</a>
</td>
<td>
<a href="delete_caste.php?id=<?php echo $row_e['id'];?>" onClick="return confirm('Are you sure you want to delete?')" title="Delete Caste" class="icon-2 info-tooltip">
