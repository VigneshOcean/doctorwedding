...
<title>Doctor Life Matrimony:Inactive Profile</title>
...
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {
	window.location='inactive_users.php';
...
$e=mysqli_query($con, "select * from  register  where status='0'  order by  name  asc");
