...
echo "<script language='javascript'>window.location='mobile_search_result.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8" />
<title>Doctor Life Matrimony:Mobile no Search</title>
...
<div class="page-header"><h1>Mobile no Search</h1></div>      
<div class="row"><div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<form class="form-horizontal" role="form" action="mobile_search.php" method="post" enctype="multipart/form-data">




<div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1"> mobile No : </label>
<div class="col-sm-9"><input  id="mobile" class="col-xs-10 col-sm-4" type="text"  name="mobile"  required></div></div>
