...
<title>Doctor Life Matrimony:Compose message</title>
...
<div class="widget-header"><h4>Write message</h4></div>
<div class="widget-body"><div class="widget-main">

<div><label for="form-field-select-3">Choose Caste</label><br />
<select class="width-48 chosen-select"  name="caste" id="caste" data-placeholder="Select Caste Name..." required>
...
while($man1=mysqli_fetch_array($man))
 {
 ?>
<option value="<?php echo $man1['id']; ?>"><?php echo ucwords((string)($man1['caste'] ?? '')); ?></option>
<?php
}
?>
</select>
...
<div><label for="form-field-select-3">Subject</label><br />
<input type="text" name="subject" id="subject" value="" required style="width: 50%;" />
</div>	

<div><label for="form-field-select-3">Message</label><br />
<textarea name="message" id="message" style="width: 80%; height: 149px;" required ></textarea>
</div>	                    
...
<button type="submit" name="submit" id="submit" class="btn btn-purple btn-sm">Send<i class="icon-envelope  icon-on-right bigger-110"></i></button>
&nbsp;&nbsp;&nbsp;

<button type="reset" name="cancel" id="cancel" class="btn btn-purple btn-sm">Reset<i class="icon-refresh  icon-on-right bigger-110"></i></button>
