...
<title>Doctor Life Matrimony:News and Events</title>
...
<input type="hidden" name="command" id="command" value="news"/>
<input type="hidden" name="news_id" id="news_id" value="2"/>
<div class="col-sm-12">
<div class="widget-box">
<div class="widget-header"><h4>News and Events</h4></div>
<div class="widget-body"><div class="widget-main">
<div><label for="form-field-select-3">Heading</label><br />
<input type="text" name="news_heading" id="news_heading" value="<?php echo $row_e122['news_heading']; ?>" style="width: 50%;" />
</div>	
<div><label for="form-field-select-3">Description</label><br />
<textarea name="descrip" id="descrip" style="width: 80%; height: 149px;" ><?php echo $row_e122['descrip']; ?></textarea>
</div>	                    
...
<button type="submit" name="submit" id="submit" class="btn btn-purple btn-sm">Add<i class="icon-save  icon-on-right bigger-110"></i></button>
&nbsp;&nbsp;&nbsp;
<a href="home.php">
<button type="button" name="cancel" id="cancel" class="btn btn-purple btn-sm">Cancel<i class="icon-refresh  icon-on-right bigger-110"></i></button>
</a>
</span>          
