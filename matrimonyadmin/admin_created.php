...
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
 {
	window.location='admin_created.php';
...
$e=mysqli_query($con, "select * from  register where profile='admin' order by  name  asc");
...
<td><?php echo ucwords($row_e['gender']); ?></td>
...
<?php if($row_e['status']=='1'){ ?>
<a href="#" onClick="getssts(<?php echo $e_id; ?>)" title="Click to deactivate" >
<button class="btn btn-xs btn-success"><i class="icon-unlock  bigger-120"></i></button>
</a>
<?php  } else { ?><a href="#" onClick="getssts(<?php echo $e_id; ?>)" title="Click to Activate" >
<button class="btn btn-xs btn-success"><i class="icon-lock  bigger-120"></i></button>
</a> <?php } ?>
...
<a href="delete_profile.php?id=<?php echo $e_id; ?>" onClick="return confirm('Are you sure you want to delete?')" title="Delete Profile">
