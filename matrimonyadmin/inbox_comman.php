...
<div class="page-header"><h1>Inbox (from contact us)</h1></div>
...
<td><a href="delete_enquiry.php?id=<?php echo $row_e['id'];?>&comm=comman" onclick="return confirm('Are you sure you want to delete?')" title="Delete Enquiry" class="icon-2 info-tooltip">Delete</a></td>
</tr>	
<?php
$i++;
}
