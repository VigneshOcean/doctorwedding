...
<title>Doctor Life Matrimony:Sent items</title>
...
$e=mysqli_query($con,"select * from  message order by id desc");
...
$e123=mysqli_query($con,"select * from  caste where id='$caste_id'");
$row_e123=mysqli_fetch_array($e123);

?>
<tr>
<td><?php echo $i; ?></td>
<td><?php echo ucwords((string)($row_e123['caste'] ?? '')); ?></td>

<td>
<?php echo ucwords((string)($row_e['subject'] ?? '')); ?>
</td>
<td>
<?php echo (string)($row_e['c_date'] ?? ''); ?>
</td>
<td>
