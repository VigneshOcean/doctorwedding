...
$_SESSION['from_date1']=$from_date;
$_SESSION['to_date1']=$to_date;
echo "<script language='javascript'>window.location='date_result.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8" />
<title>Doctor Life Matrimony:Date Search</title>
...
<div class="page-header"><h1>Date Search</h1></div>      
<div class="row"><div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
<form class="form-horizontal" role="form" action="date_search.php" method="post" enctype="multipart/form-data" >

<div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1"> From Date : </label>
<div class="col-sm-9"><input id="id-date-picker-1"  name="from_date" class="form-control date-picker" type="text" data-date-format="dd/mm/yyyy" style="width:240px; float:left;" ><span class="input-group-addon"  style="width:35px; height:34px;" >
